...
#SBATCH --output=slurm_output/build_eval_grad_hf_62_%A.out
...
PERCENTAGE=0.05
DATA_SEED=3
TRAINING_DATA_NAME=hf
TRAINING_DATA_FILE=data/eval/hf/hf_data.jsonl # when changing data name, change the data path accordingly
GRADIENT_TYPE="sgd"
