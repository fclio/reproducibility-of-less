...
#SBATCH --output=slurm_output/build_eval_grad_fiqa_%A.out
...
PERCENTAGE=0.05
DATA_SEED=3
TRAINING_DATA_NAME=fiqa
TRAINING_DATA_FILE=data/eval/fiqa/fiqa_dev.jsonl # when changing data name, change the data path accordingly
GRADIENT_TYPE="sgd"
