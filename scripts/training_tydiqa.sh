...
#SBATCH --output=slurm_output2/training_tydiqa_%A.out
...
JOB_NAME_TRAIN="llama2-7b-p${PERCENTAGE}-bm25-seed${DATA_SEED}"
TRAIN_FILES=/scratch-shared/ir2-less/selected_data/${JOB_NAME_TRAIN}/${TARGET_TASK_NAME}/bm25_top_p${PERCENTAGE}.jsonl
MODEL_PATH=meta-llama/Llama-2-7b-hf
JOB_NAME=llama2-7b-less-p${PERCENTAGE}-bm25-seed${DATA_SEED}-tydiqa
