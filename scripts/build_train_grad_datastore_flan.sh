...
#SBATCH --gpus=1
#SBATCH --job-name=flan_grad_datastore
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --gpus-per-node=1
#SBATCH --time=07:00:00
#SBATCH --output=slurm_output/build_grad_flan_%A.out
...
TRAINING_DATA_FILE=data/train/processed/flan_v2/flan_v2_data.jsonl # when changing data name, change the data path accordingly
GRADIENT_TYPE="adam"
