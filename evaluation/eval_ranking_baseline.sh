...
# Define paths
JOB_NAME="llama2-7b-less-p0.05-lora-seed4-first-${TASK_NAME}"
...
OUTPUT_PATH="/home/scur2847/ir2-less-data/eval/result/${JOB_NAME}/ranking_results_${TYPE}_${TASK_NAME}.json"
